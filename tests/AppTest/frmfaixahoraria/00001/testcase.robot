...
Resource        ../../../../resource/app/resource_frmfaixahoraria.robot
...
Testcase: Acessar Tela Faixa Horária (Inclusão)
  ...
  E clicar na aba "Faixas Horárias para Controle de Acesso"
  Então devo visualizar a tela: Faixa Horária (Inclusão)
...
E clicar na aba "Faixas Horárias para Controle de Acesso"
  resource_abahorarios.Clicar Na Aba Faixas Horárias para Controle de Acesso

Então devo visualizar a tela: Faixa Horária (Inclusão)
  resource_frmfaixahoraria.Acessar Tela Faixa Horária (Inclusão)
