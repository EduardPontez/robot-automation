...
Resource        ../../../../resource/app/resource_frmOrganograma.robot
...
Testcase: Acessar Tela Cadastro de Locais de Organograma
  ...
  Ao clicar em um registro apresentado na tela
  Então devo visualizar a tela: Cadastro de Locais de Organograma
...
Ao clicar em um registro apresentado na tela
  resource_ctrOrganograma.Clicar No Primeiro Registro

Então devo visualizar a tela: Cadastro de Locais de Organograma
  resource_frmOrganograma.Acessar Tela Cadastro de Locais de Organograma
