...
Testcase: Acessar Tela Cadastro de Feriados - Datas (Inclusão)
  ...
  Então devo visualizar a tela: Cadastro de Feriados - Datas (Inclusão)
...
Então devo visualizar a tela: Cadastro de Feriados - Datas (Inclusão)
    resource_frmferiadoxdatas.Acessar Tela Cadastro de Feriados - Datas (Inclusão)
