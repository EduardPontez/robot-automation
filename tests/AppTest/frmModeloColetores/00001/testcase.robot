...
Testcase: Acessar Tela Consulta de Modelo de Codins (Inclusão) (Busca Externa) através da tela de Cadastro de Codin
  ...
  Então devo visualizar a tela: Modelo de Codins (Inclusão) (Busca Externa)
...
Então devo visualizar a tela: Modelo de Codins (Inclusão) (Busca Externa)
  resource_frmModeloColetores.Acessar Tela Modelo de Codins (Inclusão) (Busca Externa)
