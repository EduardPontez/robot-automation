...
Resource        ../../../../resource/app/resource_frmcamercoletcftv.robot
...
Testcase: Acessar Tela Câmeras X Coletores (Inclusão)
  ...
  Então devo visualizar a tela: Câmeras X Coletores (Inclusão)
...
Então devo visualizar a tela: Câmeras X Coletores (Inclusão)
  resource_frmcamercoletcftv.Acessar Tela Câmeras X Coletores (Inclusão)
