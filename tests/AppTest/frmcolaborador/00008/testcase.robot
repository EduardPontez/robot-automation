...
${OBJETIVO}   Este caso de teste tem a finalidade de cadastrar um novo Terceiro e incluir sua ficha complementar


*** Test Cases ***

Testcase: Cadastrar Um Novo Terceiro
  ...
  Quando eu visualizar a tela: Cadastro de Terceiro - Inclusão
  ...
  E eu visualizar a tela: Terceiro
  E eu fechar a tela: Terceiro
  Então eu devo visualizar novamente a tela: Cadastro de Terceiro
  ...
  Então eu devo visualizar a tela Cadastro de Terceiro
...
E eu visualizar a tela: Terceiro
  resource_ctrgravahistorico.Acessar Tela Terceiro
E eu fechar a tela: Terceiro
  resource_ctrgravahistorico.Acessar Tela Terceiro  FECHA
Então eu devo visualizar novamente a tela: Cadastro de Terceiro
  resource_frmcolaborador.Acessar Tela Cadastro de Terceiro
Quando eu clicar no botão: Ficha Complementar
