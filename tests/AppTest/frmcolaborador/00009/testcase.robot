...
${OBJETIVO}   Este caso de teste tem a finalidade de cadastrar um novo Empregado e incluir sua ficha complementar


*** Test Cases ***

Testcase: Cadastrar Um Novo Empregado
  ...
  Quando eu visualizar a tela: Cadastro de Empregado - Inclusão
  ...
  E eu visualizar a tela: Empregado
  E eu fechar a tela: Empregado
  Então eu devo visualizar novamente a tela: Cadastro de Empregado
  ...
  Então eu devo visualizar a tela Cadastro de Empregado
...
E eu fechar a tela: Empregado
  resource_ctrgravahistorico.Acessar Tela Empregado  FECHA
Então eu devo visualizar novamente a tela: Cadastro de Empregado
  resource_frmcolaborador.Acessar Tela Cadastro de Empregado
Quando eu clicar no botão: Ficha Complementar
