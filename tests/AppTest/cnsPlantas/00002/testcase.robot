...
Testcase: Acessar Tela Consulta de Plantas (Busca Externa) através da tela de Cadastro de Codin
  ...
  E clicar no botão: Buscar Dados Externos para Código da Planta
  Então o navegador deve exibir uma nova janela e eu visualizar a tela Consulta de Plantas
...
E clicar no botão: Buscar Dados Externos para Código da Planta
  resource_frmColetores.Clicar No Botão Buscar Dados Externos Para Código da Planta

Então o navegador deve exibir uma nova janela e eu visualizar a tela Consulta de Plantas
  resource_cnsPlantas.Acessar Tela Consulta de Plantas (Busca Externa)
