...
Testcase: Acessar Tela Autorização de Entrada (Inclusão)
  ...
  Então o navegador deve exibir uma nova janela e eu visualizar a tela nome_tela (Busca Externa)
...
Então o navegador deve exibir uma nova janela e eu visualizar a tela nome_tela (Busca Externa)
  resour_cnscrachaentrada.Acessar Tela NOME_TELA (Busca Externa)
