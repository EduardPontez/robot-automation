...
*** Test Cases ***
Caso de Teste: Acessar Tela Autorização de Materiais (Inclusão)
  ...
  Então devo visualizar a tela: Autorização de Materiais (Inclusão)
...
Então devo visualizar a tela: Autorização de Materiais (Inclusão)
  resource_frmMateriaisAutorizados.Acessar Tela Autorização de Materiais (Inclusão)
