...
Resource        ../../../../resource/app/resource_frmgrupovisitanteentrada.robot
...
Então devo visualizar a tela: Cadastro de Grupo de Visitantes (Inclusão) (Busca Externa)
  resource_frmgrupovisitanteentrada.Acessar Tela Cadastro de Grupo de Visitantes (Inclusão) (Busca Externa)
