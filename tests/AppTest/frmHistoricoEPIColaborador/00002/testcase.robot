...
Testcase: Acessar Tela Consulta Histórico de EPI por Colaborador
  ...
  Então devo visualizar a tela: Consulta Histórico de EPI por Colaborador
...
Então devo visualizar a tela: Consulta Histórico de EPI por Colaborador
  resource_frmHistoricoEPIColaborador.Acessar Tela Consulta Histórico de EPI por Colaborador
