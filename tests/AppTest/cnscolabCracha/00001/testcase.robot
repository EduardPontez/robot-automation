...
Testcase: Acessar Tela Consulta de Colaboradores Crachá (Busca Externa) através da tela Provisório de Colaboradores (Inclusão)
  ...
  Então o navegador deve exibir uma nova janela e eu visualizar a tela Consulta de Colaboradores Crachá (Busca Externa)
