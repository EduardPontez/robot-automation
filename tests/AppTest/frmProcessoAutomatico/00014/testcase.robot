...
Testcase: Acessar Tela Processo Automático - On-Line - Executar Procedure/Function SGBD
  [Tags]  PRINT  POPULATED
  [Documentation]   ${OBJETIVO}

  Dado que eu acesse o menu: Processo | On-Line
  Ao visualizar a tela: Processo Automático - On-Line
  Então devo inserir "Executar Procedure/Function SGBD" no campo Tipo de Processo
