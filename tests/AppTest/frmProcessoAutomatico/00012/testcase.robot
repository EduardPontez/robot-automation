...
Testcase: Acessar Tela Processo Automático - On-Line - Excluir Log de Pendência na Tabela LOGPEND
  [Tags]  PRINT  POPULATED
  [Documentation]   ${OBJETIVO}

  Dado que eu acesse o menu: Processo | On-Line
  Ao visualizar a tela: Processo Automático - On-Line
  Então devo inserir "Excluir Log de Pendência na Tabela LOGPEND" no campo Tipo de Processo
