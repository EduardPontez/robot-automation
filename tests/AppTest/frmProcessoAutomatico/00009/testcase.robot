...
Testcase: Acessar Tela Processo Automático - On-Line - Comando: Bloqueio e Desbloqueio
  [Tags]  PRINT  POPULATED
  [Documentation]   ${OBJETIVO}

  Dado que eu acesse o menu: Processo | On-Line
  Ao visualizar a tela: Processo Automático - On-Line
  Então devo inserir "Comando: Bloqueio e Desbloqueio" no campo Tipo de Processo
