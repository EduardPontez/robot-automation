...
class Custom(object):
    ...
    def highlight_element(self, locator):
        ...
        if element_type == 'id':
            el = self._driver.driver.find_element_by_id(element_locator)            
        
        if element_type == 'name':
            el = self._driver.driver.find_element_by_name(element_locator)            
            
        if element_type == 'xpath':
            el = self._driver.driver.find_element_by_xpath(element_locator)            
    ...
    #     #el_1 = el_1.replace('"', "'")
    #     #el = self._driver.driver.find_element_by_xpath(el)
